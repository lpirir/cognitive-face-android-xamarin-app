...
namespace com.rcervantes.xamarinfaceapi_droid.ui
{
    ...
    public class GroupingActivity : AppCompatActivity
    {
        ...
        {
            private Android.Runtime.JavaList<Android.Runtime.JavaList<UUID>> faceGroups;
            private GroupingActivity activity;

            public FaceGroupsAdapter(GroupResult result, GroupingActivity act)
            {
                faceGroups = new Android.Runtime.JavaList<Android.Runtime.JavaList<UUID>>();
                activity = act;

                if (result != null)
                {
                    List<UUID[]> list = result.Groups as List<UUID[]>;
                    ...
                    //foreach (UUID[] g in list)
                    //{
                    //    faceGroups.Add(g.ToList());
                    //}
		...
		{
			private Android.Runtime.JavaList<UUID> faces;
			private GroupingActivity activity;

			public FacesAdapter(Android.Runtime.JavaList<UUID> result, GroupingActivity act)
			{
				faces = new Android.Runtime.JavaList<UUID>();
