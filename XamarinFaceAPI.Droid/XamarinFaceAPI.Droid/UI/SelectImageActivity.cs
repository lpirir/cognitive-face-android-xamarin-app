...
namespace com.rcervantes.xamarinfaceapi_droid.ui
{
    ...
    public class SelectImageActivity : AppCompatActivity
    {
        ...
        private Android.Net.Uri mUriPhotoTaken;
        ...
        protected override void OnRestoreInstanceState(Bundle savedInstanceState)
        {
            ...
            mUriPhotoTaken = (Android.Net.Uri)savedInstanceState.GetParcelable("ImageUri");
        }
        ...
        void Button_Take_A_Photo_Click(object sender, EventArgs e)
        {
            ...
            if (intent.ResolveActivity(PackageManager) != null)
            {
                ...
                try
                {
                    ...
                    mUriPhotoTaken = Android.Net.Uri.FromFile(file);
