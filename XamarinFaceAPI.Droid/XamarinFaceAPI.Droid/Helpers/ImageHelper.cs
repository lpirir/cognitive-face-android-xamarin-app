...
namespace XamarinFaceAPI.Droid
{
	public class ImageHelper
	{
		...
		public static Bitmap LoadSizeLimitedBitmapFromUri(Android.Net.Uri imageUri, ContentResolver contentResolver)
		{
			try
			{
		...
		public static Bitmap DrawFaceRectanglesOnBitmap(Bitmap originalBitmap, Face[] faces, bool drawLandmarks)
		{
		...
		private static int GetImageRotationAngle(Android.Net.Uri imageUri, ContentResolver contentResolver)
		{
			int angle = 0;
